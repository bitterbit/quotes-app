...
/**
 * A card model that represents all the basic information about a {@link com.fima.cardsui.objects.Card}
 * (actually, it's a concrete copy of {@link AbstractCard} that's
 * {@link java.io.Serializable}). CardModel objects can be used to store information
 * about cards across configuration changes, or even saved to USB storage.
 * 
 * <p>
 * To turn a {@link com.fima.cardsui.objects.CardModel} into a Card, use {@link CardFactory}.
 * 
 * @author FLamparski
