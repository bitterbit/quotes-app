...
public final class UndoBar {
	 ...
	 * 
	 * @param shouldAnimate
	 *            whether the {@link com.jensdriller.libs.undobar.UndoBar} should animate in
	 */
	 ...
	 * 
	 * @param shouldAnimate
	 *            whether the {@link com.jensdriller.libs.undobar.UndoBar} should animate out
	 */
	...
	/**
	 * Checks if there is already an {@link com.jensdriller.libs.undobar.UndoBarView} instance added to the
	 * given {@link android.app.Activity}.<br>
	 * If {@code true}, returns that instance.<br>
	 * If {@code false}, inflates a new {@link com.jensdriller.libs.undobar.UndoBarView} and returns it.
	 */
	...
	public static class Builder {
		 ...
		 * 
		 * @param shouldAnimate
		 *            whether the {@link com.jensdriller.libs.undobar.UndoBar} should animate in and out.
		 */
		public void show(boolean shouldAnimate) {
